...
<body>
    <?php renderLayoutStart($user, 'add-attendance', $headerLabel); ?>
        ...
        <div class="action-bar-left" style="flex: 1;">
            ...
            <div style="width: 100%; max-width: 250px;">
                <div class="autocomplete-wrapper">
                    <input type="text" id="filter-deploc" class="form-control" placeholder="Dep. Location..." autocomplete="off">
                    <div class="autocomplete-dropdown" id="filter-deploc-dropdown"></div>
                    <!-- Hidden field not strictly needed for filter, but autocomplete logic might expect it or we can pass null -->
                </div>
            </div>
        </div>
    ...
    <section class="card">
        ...
        <form action="#" method="POST" class="form-grid" id="staff-form">
            ...
            <div class="form-group" style="margin-bottom: 0;">
                ...
                <div class="autocomplete-wrapper">
                    <input type="text" id="staff-name" class="form-control" placeholder="Type employee name..." required
                        autocomplete="off">
            ...
            <div class="form-group" style="margin-bottom: 0;">
                ...
                <div class="autocomplete-wrapper">
                    <input type="text" id="staff-id" class="form-control" placeholder="Type employee ID..." required
                        autocomplete="off">
            ...
            <input type="hidden" id="staff-deploc-validated" value="0">
            <div class="form-group" style="margin-bottom: 0;">
                <label for="staff-deploc" class="form-label">Dep. Location</label>
                <div class="autocomplete-wrapper">
                    <input type="text" id="staff-deploc" class="form-control" placeholder="Type location"
                        autocomplete="off">
                    <div class="autocomplete-dropdown" id="deploc-dropdown"></div>
                </div>
            </div>
            <div class="form-group" style="margin-bottom: 0;">
    ...
    <div class="action-bar"
        style="justify-content: center; gap: 1rem; flex-wrap: wrap; background: transparent; box-shadow: none; padding: 0;">
